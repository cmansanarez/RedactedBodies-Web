...
const FALLBACK_PROJECTS = [
    { id: 1, name: 'Lumyn: Constellation of Self', image: 'noirmak-visit-lumyn.jpg', description: 'An interactive installation that transforms participant reflections into generative poetry, color, and constellation-inspired visual compositions. Through AI, creative coding, and projection, Lumyn creates a collective archive of identity, affirmation, and belonging.', url: 'https://visit-lumyn.noirmak.com/', tags: ['Interactive', 'Installation', 'Experiential', 'Generative Art', 'Node.js', 'Express.js', 'Three.js', 'AI-Assisted', 'Projection'] },
